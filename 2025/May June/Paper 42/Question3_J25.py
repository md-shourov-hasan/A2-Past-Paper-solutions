class Animal:
    ...
    def Description(self):
        return "The animal's name is " + self.Name + ", it makes a " + self.Sound + ", its size is " + str(self.Size) +  " and its intelligence level is " + str(self.Intelligence)
...
class Parrot(Animal):
    ...
    def Description(self):
        return "The animal's name is " + self.Name + ", it makes a " +self.Sound+ ", its size is " +str(self.Size)+ " and its intelligence level is "+ str(self.Intelligence)+  ". It has a wingspan of " + str(self.WingSpan) + "cm and can say " + str(self.NumberWords) + " words."
...
class Wolf(Animal):
    ...
    def Description(self):
        return "The animal's name is " + self.Name + ", it makes a " + self.Sound + ", its size is " + str(self.Size) + " and its intelligence level is " + str(self.Intelligence) + ". Its territory is " + str(self.TerritorySize) + " square miles."
